    ...
    <div className="flex min-h-screen flex-col bg-muted">
      ...
      <div className="flex-1 flex items-center justify-center py-10 px-6 lg:px-12">
        <Card className="w-full max-w-2xl">
          <CardHeader>
            <h1 className="text-2xl font-bold">UPI/Wallet Setup</h1>
            <p className="text-muted-foreground">Add your payment method</p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="bank" placeholder="Enter account number" />
            </div>
